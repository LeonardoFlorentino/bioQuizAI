...
public class QuestionController {
    ...
    public List<Question> getQuestion(@RequestParam(required = false) String category,
        ...
        List<Question> questions = List.of(new Question("Qual é a organela responsável pela respiração celular?",
                List.of("Ribossomo", "Mitocôndria", "Lisossomo", "Núcleo"), "Mitocôndria", "Citologia", "Fácil"),
                new Question("Qual molécula carrega a informação genética?",
                        List.of("RNA", "Proteína", "DNA", "Lipídio"), "DNA", "Genética", "Médio"),
                new Question("Qual processo as plantas usam para produzir energia?",
                        List.of("Respiração", "Fermentação", "Fotossíntese", "Digestão"), "Fotossíntese", "Bioquímica",
                        "Fácil"));
